...
**Doc:** CBR-PRD-001 · **Version:** v1.0 · status updated 2026-09-15 · **Status:** Active · **Current phase:** 13 — Strategy Fidelity / Behavioral Parity (run CBR-RUN-013B-2: **FAIL**, accepted by the owner in D26; PC2 frozen as the failed candidate; Phase 13R spec reconciliation returned for review; Phases 9-12 accepted with concerns) · **Instruments:** XAUUSD + DXY
