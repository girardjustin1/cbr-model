...
**Doc:** CBR-PRD-001 · **Version:** v1.0 · status updated 2026-09-16 · **Status:** Active · **Current phase:** 13 — Strategy Fidelity / Behavioral Parity (PC2 run CBR-RUN-013B-2: **FAIL**, accepted in D26 and frozen as the failed candidate; PC3 scored run **CBR-RUN-013C-1: FAIL**, accepted in D32; D33 evidence resolution returned — **PC4 NOT READY**, four owner rulings outstanding; Phases 9-12 accepted with concerns) · **Instruments:** XAUUSD + DXY
