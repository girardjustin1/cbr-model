...
**Doc:** CBR-PRD-001 · **Version:** v1.0 · status updated 2026-09-18 · **Status:** Active · **Current phase:** 14A — Authoritative Execution Simulator (**Phase 13 CLOSED (D37): RESEARCH-SUFFICIENT WITH DOCUMENTED FIDELITY CONCERNS**; the scored parity record is unchanged and stays **FAIL** for PC2 CBR-RUN-013B-2, PC3 CBR-RUN-013C-1 and PC4 CBR-RUN-013D-1; PC4 promoted to the frozen `CBR1H_BASELINE_V1`; 14A blocked on ten execution rulings; Phases 9-12 accepted with concerns) · **Instruments:** XAUUSD + DXY
