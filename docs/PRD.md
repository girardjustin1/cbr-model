...
**Doc:** CBR-PRD-001 · **Version:** v1.0 · status updated 2026-09-15 · **Status:** Active · **Current phase:** 13 — Strategy Fidelity / Behavioral Parity (run CBR-RUN-013B-2 executed; Research Engineer report FAIL under the frozen D25 rules, awaiting owner verdict; Phases 9-12 accepted with concerns) · **Instruments:** XAUUSD + DXY
