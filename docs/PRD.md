...
**Doc:** CBR-PRD-001 · **Version:** v1.0 · status updated 2026-09-17 · **Status:** Active · **Current phase:** 13 — Strategy Fidelity / Behavioral Parity (PC2 run CBR-RUN-013B-2: **FAIL**, accepted in D26 and frozen as the failed candidate; PC3 scored run **CBR-RUN-013C-1: FAIL**, accepted in D32; **PC4 scored under D35: CBR-RUN-013D-1 FAIL**, returned for the owner's Phase 13D verdict — 2 of 3 positives clean, the first eligible course signals any candidate has produced; Phases 9-12 accepted with concerns) · **Instruments:** XAUUSD + DXY
